...
from agent import graph, save_conversation_to_db, conversations_collection
import os
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    existing_conversation = conversations_collection.find_one({"session_id": SINGLE_SESSION_ID})
...
async def clear_history(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    conversations_collection.delete_one({"session_id": SINGLE_SESSION_ID})
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        save_conversation_to_db(result, SINGLE_SESSION_ID)
...
async def get_stats(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    conversation = conversations_collection.find_one({"session_id": SINGLE_SESSION_ID})
